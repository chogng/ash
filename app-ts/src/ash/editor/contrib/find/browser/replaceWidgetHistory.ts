...
export class ReplaceWidgetHistory {
	...
	public static getOrCreate(storageService: IStorageService): ReplaceWidgetHistory {
		return this.instance ??= new ReplaceWidgetHistory(storageService);
	}
	...
	public async save(): Promise<void> {
		...
		this.storageService.store(ReplaceWidgetHistory.FIND_HISTORY_KEY, JSON.stringify(values), StorageScope.WORKSPACE, StorageTarget.USER);

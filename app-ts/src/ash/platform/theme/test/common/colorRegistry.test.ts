...
test("ColorRegistry resolves aliases and transforms deterministically", () => {
	...
	registry.registerColor("surface.background", { dark: "#000000", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata);
	registry.registerColor("surface.overlay", { dark: transparent("surface.background", 0.5), light: transparent("surface.background", 0.25), highContrastDark: null, highContrastLight: null }, { ...metadata, needsTransparency: true });
...
test("ColorRegistry rejects duplicates, cycles, unknown references, and unknown overrides", () => {
	...
	duplicate.registerColor("test.color", { dark: "#000000", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata);
	assert.throws(() => duplicate.registerColor("test.color", { dark: "#000000", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata), /already registered/);

	using cyclic = new ColorRegistry();
	cyclic.registerColor("cycle.first", { dark: "cycle.second", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata);
	cyclic.registerColor("cycle.second", { dark: "cycle.first", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata);
	assert.throws(() => cyclic.resolve(ColorScheme.Dark), /cycle\.first -> cycle\.second -> cycle\.first/);

	using unknown = new ColorRegistry();
	unknown.registerColor("test.color", { dark: "missing.color", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata);
...
test("color contributions publish a new catalog without changing earlier snapshots", () => {
	...
	colors.registerColor("late.color", { dark: "#000000", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata);
	...
	assert.throws(() => colors.registerColor("late.color", { dark: "#000000", light: "#ffffff", highContrastDark: "#000000", highContrastLight: "#ffffff" }, metadata), /already registered/);

...
export const settingsHeaderForeground = registerColor('settings.headerForeground', { dark: 'foreground', light: 'foreground' }, {
	description: 'Foreground for Settings editor section headers.',
	owner,
});

export const settingsHeaderBorder = registerColor('settings.headerBorder', { dark: 'widget.border', light: 'widget.border' }, {

...
**Location**: `src/ash/[path/to/component]`
...
- **`src/ash/[path/to/component]/[filename.ts]`**: [Purpose and main exports]
- **`src/ash/[path/to/component]/[service.ts]`**: [Service implementation details]
- **`src/ash/[path/to/component]/[contribution.ts]`**: [Workbench contributions]

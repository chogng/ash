...
The authoritative contributor contract is [src/ash/workbench/contrib/onboarding/README.md](../../../src/ash/workbench/contrib/onboarding/README.md). Read it before implementation. This skill owns the execution workflow and must not duplicate a catalogue of current tryouts.
...
- [diffEditorTryout.contribution.ts](../../../src/ash/workbench/contrib/codeEditor/browser/diffEditorTryout.contribution.ts) — isolated editor sample.
- [modelPickerTryout.contribution.ts](../../../src/ash/workbench/contrib/chat/browser/onboarding/modelPickerTryout.contribution.ts) — scoped multi-instance target.
...
See [onboardingTarget.ts](../../../src/ash/workbench/contrib/onboarding/browser/spotlight/onboardingTarget.ts), [guidedTryoutPresentation.ts](../../../src/ash/workbench/contrib/onboarding/browser/guidedTryoutPresentation.ts), and [spotlightPresentation.ts](../../../src/ash/workbench/contrib/onboarding/browser/spotlight/spotlightPresentation.ts).
...
- Preserve the `ash/sessions` → `ash/workbench` layer direction.
...
Invoke the `sessions` skill for changes under `src/ash/sessions/**`.
...
Use [releaseNotesTryouts.md](../../../src/ash/workbench/contrib/onboarding/test/browser/fixtures/releaseNotesTryouts.md) for manual validation, not as another source of feature contracts.
...
- [onboardingTryoutService.test.ts](../../../src/ash/workbench/contrib/onboarding/test/browser/onboardingTryoutService.test.ts)
- [onboardingTryoutActions.test.ts](../../../src/ash/workbench/contrib/onboarding/test/browser/onboardingTryoutActions.test.ts)
- [guidedTryoutPresentation.test.ts](../../../src/ash/workbench/contrib/onboarding/test/browser/guidedTryoutPresentation.test.ts)
- [spotlightPresentation.test.ts](../../../src/ash/workbench/contrib/onboarding/test/browser/spotlightPresentation.test.ts)
- [onboardingTryoutWindow.test.ts](../../../src/ash/workbench/contrib/onboarding/test/electron-browser/onboardingTryoutWindow.test.ts)

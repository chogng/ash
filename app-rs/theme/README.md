...
- 将快照转换为组件颜色、尺寸和字体角色，供 Workbench 原子应用。
- 根据 GUI 的界面字体族与基础字号形成 UiTypography。
- 不拥有主题选择配置、组件状态或布局规则。
...
验证命令：`just check ash-ui-theme`、`just test ash-ui-theme`、`just rust-warnings ash-ui-theme`。

...
export class TextMateSyntaxWorkerClient extends Disposable implements SyntaxWorker, LanguageWorkerModelSynchronizer, LanguageWorkerResultSettler {
	private readonly worker: WorkerTextModelSyncClient<SyntaxLane, SyntaxRequest, SyntaxResult>;
	...
	constructor(
		...
		this.worker = this._register(new WorkerTextModelSyncClient(port, syntaxWireCodec));

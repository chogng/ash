...
for name, env in [('full', os.environ.copy()), ('modules', {k:v for k,v in os.environ.items() if k.lower() in keys + ['psmodulepath']})]:
    ...
    try:
        ...
        print(name, 'TIMEOUT', error.stdout, error.stderr, flush=True)
        continue

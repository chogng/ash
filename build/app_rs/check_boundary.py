...
EXPECTED_APP_MEMBERS = {
    ...
    "app-rs/editor-core",
    "app-rs/icons",
    "app-rs/input-classifier",
    "app-rs/markdown",
    "app-rs/keybindings",
    "app-rs/settings",
    "app-rs/shell-completion",
    "app-rs/terminal",
    "app-rs/terminal-runtime",
    "app-rs/text-file",
    "app-rs/workbench",
    "app-rs/zui",
}
...
RETIRED_PRODUCT_PATHS = {
    "app-rs/composer",
    "app-rs/src",
    "app-rs/src/workbench_host",
    "app-rs/src/workbench_host.rs",
    "app-rs/workbench-model",
    "ash-rs/native",
    "ash-rs/agent-sidebar",
    "ash-rs/editor",
    "ash-rs/editor-core",
    "ash-rs/icons",
    "ash-rs/input-classifier",
    "ash-rs/markdown",
    "ash-rs/renderer",
    "ash-rs/settings",
    "ash-rs/shell-completion",
    "ash-rs/terminal",
    "ash-rs/text-file",
    "ash-rs/ui",
    "ash-rs/wgpu",
...
def main() -> int:
    ...
    if "[workspace]" in app_manifest:
        fail("app-rs/Cargo.toml still defines a nested workspace")
    ...
    launch_path = repository_root / "app-rs" / "workbench" / "remote" / "launch.rs"
    ...
    if default_members is None or '"app-rs"' not in default_members.group(1):
    ...
    if (repository_root / "app-rs" / "Cargo.lock").exists():
        fail("app-rs/Cargo.lock still exists; the root lockfile must be canonical")

import { resolveLivekit } from '../runtime/livekit.ts';
import { developmentHostTarget } from '../runtime/store.ts';
...
const generationDirectory = appTsBuildPath(repositoryRoot, "dev", "app-server");

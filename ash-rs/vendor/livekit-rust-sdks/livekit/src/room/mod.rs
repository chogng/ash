...
pub struct RoomOptions {
    /// Optional room-scoped signaling transports, retained across reconnects.
    pub transport: Option<livekit_signaling::SignalTransport>,
...
impl Room {
    pub async fn connect(
        ...
        signal_options.transport = options.transport.clone();

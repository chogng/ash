#![allow(deprecated)]
// Upstream legacy wire fields and public compatibility APIs remain supported.
...
// Ash: callers can name statistics and scope network policy to one room.
pub use livekit_signaling::SignalTransport;

...
const UI_TRANSLATIONS: &[Translation] = &[
    ...
    translation(
        ...
        "zai でサインイン",
        "使用 zai 登录",
        "Se connecter avec zai",
    ),
    translation(
        "Enter the API key from your zai Coding Plan",
        "zai Coding Plan の API キーを入力してください",
        "请输入 zai Coding Plan 的 API 密钥",
        "Saisissez la clé API de votre offre zai Coding Plan",
    ),
    translation("Enable zai", "zai を有効化", "启用 zai", "Activer zai"),
    translation("Disable zai", "zai を無効化", "停用 zai", "Désactiver zai"),

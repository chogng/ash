...
const fn english(message: Message) -> &'static str {
    match message {
        ...
        Message::ConfigApiAndLocalServices => "API and local services",
...
const fn japanese(message: Message) -> &'static str {
    match message {
        ...
        Message::ConfigApiAndLocalServices => "API とローカルサービス",
...
const fn chinese(message: Message) -> &'static str {
    match message {
        ...
        Message::ConfigApiAndLocalServices => "API 与本地服务",
...
const fn french(message: Message) -> &'static str {
    match message {
        ...
        Message::ConfigApiAndLocalServices => "API et services locaux",

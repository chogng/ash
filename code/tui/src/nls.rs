...
const UI_TRANSLATIONS: &[Translation] = &[
    ...
    translation(
        "Signed out of Super Grok",
        "Super Grok からログアウトしました",
        "已退出 Super Grok 登录",
        "Déconnecté de Super Grok",
    ),
    translation(
        "Signed out of Kimi",
        "Kimi からログアウトしました",
    ...
    translation(
        ...
        "Z.AI でサインイン",
        "使用 Z.AI 登录",
        "Se connecter avec Z.AI",
    ),
    translation("BigModel", "BigModel", "BigModel", "BigModel"),
    translation("Z.AI", "Z.AI", "Z.AI", "Z.AI"),
    translation(
        "Enter the API key from your BigModel",
        "BigModel の API キーを入力してください",
        "请输入 BigModel 的 API 密钥",
        "Saisissez la clé API de votre offre BigModel",
    ),
    translation(
        "Enter the API key from your Z.AI",
        "Z.AI の API キーを入力してください",
        "请输入 Z.AI 的 API 密钥",
    ...
    translation(
        ...
        "ChatGPT からログアウトしました",
        "已退出 ChatGPT 登录",
        "Déconnecté de ChatGPT",
    ),
    translation("sign out", "ログアウト", "退出登录", "se déconnecter"),
    translation(
        "Sign in again",
        "再度サインイン",
        "重新登录",
